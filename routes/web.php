...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('shift-logs')->name('shift-logs.')->group(function () {
        ...
        Route::get('/{shiftLog}/close', [ShiftLogController::class, 'closeForm'])->name('close.form');
    ...
    // Accounting
    Route::get('accounts',          [AccountingController::class, 'index'])->name('accounts.index');
    Route::resource('accounts', AccountingController::class)->except('index');
